"""Derived policy: the freeze cost model and search-budget math (Phase 3, §3.1).

Pure functions over the plan's stated formulas. No side effects, no I/O -- the
knobs (``c_m``, ``c_e``, ``gamma_e``, ``epsilon``, ``delta``, ``gamma``) are
estimates a caller supplies or defaults; see the plan's §7 for the honest
limitation that a wrong cost input shifts *when* you freeze, not *whether*
safety holds.
"""
